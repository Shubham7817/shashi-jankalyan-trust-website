...
const box_shadow_painter_1 = require("./box-shadow-painter");
    ...
    async renderNodeBackgroundAndBorders(paint) {
        ...
        if (hasBackground || styles.boxShadow.length) {
            ...
            for (const shadow of styles.boxShadow.slice(0).reverse()) {
                ...
                await (0, box_shadow_painter_1.paintBoxShadow)(this.ctx, paint, shadow, this.options, this.surfaceBudget);
            }
        }
