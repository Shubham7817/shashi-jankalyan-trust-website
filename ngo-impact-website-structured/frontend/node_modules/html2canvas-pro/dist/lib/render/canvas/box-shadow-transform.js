...
const shadowSpace = (matrix, width, height) => {
    ...
    if (!corners.every((point) => Number.isFinite(point.x) && Number.isFinite(point.y)))
        return null;
    ...
    return {
        matrix,
        viewport: new bounds_1.Bounds(left, top, right - left, bottom - top),
        scale,
