...
export default function Donate() {
  ...
  return (
    <div className="bg-gray-50/50 min-h-screen pb-16 md:pb-24 w-full overflow-hidden">
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 pt-8 md:pt-12 w-full max-w-7xl">
        {/* Responsive Grid: Single column on mobile/tablet, 7/5 split on large desktops */}
        <div className="flex flex-col lg:grid lg:grid-cols-12 lg:items-start gap-8">
          
          {/* ========================================== */}
          {/* LEFT COLUMN: THE FORM */}
          {/* ========================================== */}
          <div className="w-full lg:col-span-7">
            <div className="w-full rounded-2xl bg-white shadow-sm border border-gray-100 p-5 sm:p-8">
              <DonationForm />
            </div>
          </div>
          ...
          <div className="w-full lg:col-span-5 flex flex-col gap-6 lg:sticky lg:top-24">
            ...
            {/* 2. RECENT SUPPORTERS */}
            <div className="w-full rounded-2xl bg-white p-5 sm:p-6 shadow-sm border border-gray-100">
              ...
              {recentDonors.length === 0 ? (
                ...
                <div className="flex flex-wrap content-start gap-2 sm:gap-3 max-h-48 overflow-y-auto pr-2 custom-scrollbar">
                  {recentDonors.map((donor, index) => (
                    <div 
                      key={index} 
                      className="flex items-center gap-2 rounded-full border border-gray-200 bg-gray-50 py-1.5 pl-1.5 pr-3.5 shadow-sm transition-all hover:border-green-300 hover:bg-white w-full sm:w-auto max-w-full"
                    >
            ...
            <div className="w-full rounded-2xl bg-white p-5 sm:p-6 shadow-sm border border-gray-100">
              ...
              {/* Responsive Legend */}
              <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 gap-y-3 sm:gap-y-4 gap-x-2">
                {allocation.map(([name, value], index) => {
                  const colors = ["bg-green-800", "bg-green-600", "bg-green-400", "bg-emerald-300", "bg-teal-100"];
                  return (
